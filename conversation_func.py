...
def conversation_to_features(
    ...
    # labels = None   # TODO: implement the loss mask
    # attention = None   # TODO: implement the attention mask
    ...
    if is_single_turn_conversation(messages):
        ...
        # raise NotImplementedError("Exercise 1: loss mask for single turn conversation.")
    else:
        # ------------------------------------------------------------------
        ...
        #     masking decisions.
        #
        # After implementing, remove or replace the exception below.
        # ------------------------------------------------------------------
        # ----- implement here -----
        prev = 0
        for msg, current_len in zip(messages, prefix_lengths):
